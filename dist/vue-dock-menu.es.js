  ...
  function e(e) {
    ...
    function c(t) {
      t.metaKey ||
        t.altKey ||
        t.ctrlKey ||
        (i(e.activeElement) && r(e.activeElement), (n = !0));
    }
    function s(e) {
      n = !1;
    }
    function d(e) {
      i(e.target) && (n || u(e.target)) && r(e.target);
    }
    function v(e) {
      i(e.target) &&
    ...
    function f(e) {
      "hidden" === document.visibilityState && (t && (n = !0), m());
    }
    function m() {
...
var C = function (e, n) {
    var t = window.innerHeight,
      ...
      u = n.x,
      r = n.y,
      l = { dragActive: !1, dockPosition: x.NOT_AVAILABLE };
    if (e instanceof DragEvent)
      (a = Math.round((u / o) * 100)), (i = Math.round((r / t) * 100));
    else if (e instanceof TouchEvent) {
      var c = e.changedTouches[0];
      if (Boolean(c)) {
        var s = c.clientX,
          d = c.clientY;
        (a = Math.round((s / o) * 100)), (i = Math.round((d / t) * 100));
      }
    }
    return (
      a < 10 && (l.dockPosition = x.LEFT),
      a > 90 && (l.dockPosition = x.RIGHT),
      i > 90 && (l.dockPosition = x.BOTTOM),
      i < 10 && (l.dockPosition = x.TOP),
      l.dockPosition !== x.NOT_AVAILABLE ? l : null
    );
  },
  I = function (e) {
    if (e instanceof DragEvent) {
...
var O = function () {
  ...
  q = [o("polyline", { points: "9 18 15 12 9 6" }, null, -1)];
function K(e) {
  for (var n = void 0, t = e[0], o = 1; o < e.length; ) {
    var a = e[o],
      i = e[o + 1];
...
(P.render = function (e, o, a, i, u, r) {
  return n(), t("svg", _, q);
}),
  (P.__file = "src/components/ChevRight.vue");
var R = e({
    name: "DockMenu",
    components: { ChevRight: P },
    props: {
      items: { type: Array, default: [], required: !0 },
      dock: { required: !1, default: x.TOP, type: String },
    ...
    setup: function (e, n) {
      var t = n.emit,
        ...
        v = function (e, n) {
          e &&
            (c.value ? (s.value = null) : (s.value = n), (c.value = !c.value));
        },
        f = i(),
        m = i(),
        h = i(e.initialHighlightIndex),
        p = i(-1),
        g = u(function () {
          return {
      ...
      var w = function () {
        var e = m.value.closest(".menu-bar-item-container");
        e && e.focus();
      };
      return {
        MenuComponent: o,
        ...
        handleKeyDown: function (e) {
          if (f.value) {
            ...
            (n = K([
              ...
              : n) >= 0 && n < b.value
              ? (h.value = n)
              : n > b.value - 1 && (h.value = 0);
          }
        },
        handleKeyLeft: function (n) {
          f.value && (e.nested ? (n.stopPropagation(), t("close-menu")) : w());
        },
        handleKeyRight: function (e) {
          if (f.value) {
            var n = y.value[h.value];
            n && n.menu
              ? (e.stopPropagation(), (p.value = 0), v(!!n.menu, n.id))
              : w();
          }
        },
        handleKeySelection: function (n) {
          if (h.value >= 0) {
            var t = y.value[h.value];
            n.stopPropagation(),
              K([
                t,
                "optionalAccess",
                ...
                : t &&
                  e.onSelected({
                    name: t.name,
                    path: (e.parent + ">" + t.name).toLowerCase(),
                  });
          }
        },
        ...
        showSubMenu: c,
        subMenuHighlightIndex: p,
        toggleSubMenu: v,
      };
    },
  }),
  N = ["onMouseenter", "onMouseleave", "onClick", "onTouchend"],
  F = { key: 0, class: "menu-item-icon" },
  H = { class: "name" },
  j = { key: 1, class: "menu-item-divider" };
(R.render = function (e, i, u, r, l, k) {
  var L = a("ChevRight");
  return (
    n(),
    t(
      "div",
      {
        class: c([e.dockClass, "menu-wrapper"]),
        style: s({ background: e.theme.secondary }),
      },
      [
        o(
          "ul",
                  ...
                  t(
                    "li",
                    {
                      ...
                      class: c([
                        ...
                        {
                          "is-parent": !!a.menu,
                          highlight: i === e.highlightedIndex,
                          divider: a.isDivider,
                          disable: a.disable,
                        },
                      ]),
                      style: s(e.menuItemStyle),
                      onMouseenter: function (n) {
                        return (
                          a.menu &&
                          !e.isMobile &&
                          e.toggleSubMenu(!!a.menu, a.id)
                        );
                      },
                      ...
                      a.isDivider
                        ...
                        : (n(),
                          t(
                            ...
                            [
                              a.iconSlot
                                ? (n(), t("span", F, [m(e.$slots, a.iconSlot)]))
                                : h("v-if", !0),
                              o("span", H, p(a.name), 1),
                              o(
                                "span",
                              ...
                              a.menu && e.showSubMenu && a.id === e.activeMenuId
                                ? (n(),
                                  t(
                                    "div",
                                    {
  ...
  (R.__scopeId = "data-v-9bcc0be2"),
  (R.__file = "src/components/Menu.vue");
var U = e({
    name: "MenuBarItem",
    components: { DockMenu: R },
    props: {
      ...
      dock: { required: !0, default: x.TOP, type: String },
    ...
    setup: function (e, n) {
      var t = n.emit,
        ...
        d = i(!1),
        v = function (n) {
          t(n ? "activate" : "deactivate", e.id);
        },
        f = function (n) {
          n.stopPropagation(), (d.value = !d.value), t("show", d.value, e.id);
        },
        m = i(-1),
        h = function () {
          var n = {},
          ...
          e.dock === x.LEFT
            ...
            : e.dock === x.BOTTOM && ((n.bottom = a + "px"), (n.left = "0px")),
            (c.value = n);
        },
        p = u(function () {
          return [
      ...
      var g = u(function () {
          return a.value ? e.theme.secondary : "transparent";
        }),
        y = u(function () {
        ...
        handleKeyUp: function (n) {
          ...
          "Tab" === o
            ...
            ? e.activeMenuSelectionIndex < 0
              ? t("show", !e.menuActive, e.id)
              : t("select-highlighted-menu-item")
            : "Escape" === o
            ? t("show", !1)
            : ("ArrowRight" === o && "horizontal" === a) ||
              ("ArrowDown" === o && "vertical" === a)
            ? t("activate-next", e.id, "next")
            : ("ArrowLeft" === o && "horizontal" === a) ||
              ("ArrowUp" === o && "vertical" === a)
            ? t("activate-previous", e.id, "prev")
            : "ArrowDown" === o && "horizontal" === a
            ? t("highlight-menu-item", "down", e.id)
            : "ArrowUp" === o &&
              "horizontal" === a &&
              t("highlight-menu-item", "up", e.id);
        },
        highlightIndex: m,
      };
    },
...
(U.render = function (e, i, u, r, l, d) {
  ...
  return (
    ...
    t(
      ...
      {
        ref: "menuBarItemRef",
        class: c(e.menuBarStyle.concat(["menu-bar-item-container"])),
        style: s({ background: e.bgColor }),
        tabindex: "0",
        onMouseenter:
          i[0] ||
          (i[0] = function (n) {
      ...
      [
        o(
          "span",
          {
            class: c(e.menuBarStyle.concat(["name-container"])),
            style: s({ color: e.theme.textColor }),
          },
          [
            e.showIcon
              ? (n(), t("span", V, [o("i", { class: c(e.icon) }, null, 2)]))
              : (n(), t("span", G, p(e.name), 1)),
          ],
          6
        ),
        o(
          "span",
          { class: "menu-container", style: s(e.menuStyle) },
          [
            g(
              D,
              { name: "fade" },
                    ...
                    e.menuActive && e.showMenu
                      ? (n(),
                        y(
                          ...
                          w({ _: 2 }, [
                            f(Object.keys(e.$slots), function (n) {
                              return {
                                name: n,
                                fn: M(function (t) {
                                  return [m(e.$slots, n, A(E(t)))];
                                }),
                              };
                            }),
                          ]),
  ...
  (U.__scopeId = "data-v-d6123432"),
  (U.__file = "src/components/MenuBarItem.vue");
var W = document.removeEventListener,
  z = document.addEventListener,
  X = e({
    name: "MenuBar",
    components: { MenuBarItem: U },
    props: {
      showIcon: { type: Boolean, default: !1 },
    ...
    setup: function (e) {
      var n = i(),
        ...
        A = function (e) {
          return (y.value = { x: e.clientX, y: e.clientY });
        };
      r(function () {
        var e = n.value;
        (d.value = $([
          ...
          f.value
            ...
            : (W("click", M),
              e &&
                ...
                e.removeEventListener("mouseleave", w))),
            W("dragover", A);
        });
      var E = function (e) {
          h.value = h.value.map(function (n) {
        ...
        D = u(function () {
          return c.value === x.LEFT || c.value === x.RIGHT
            ? l.value
              ? "expanded"
              : "not-expanded"
            : "";
      ...
      return {
        activeMenuBarId: g,
        activeMenuSelection: p,
        barHeight: d,
        barWidth: v,
        dockClass: s,
        dockPosition: c,
        expandClass: D,
        handleActivateDir: function (e, n) {
          var t = (function (e, n, t, o, a) {
            ...
            return B([
              ...
              : { navigateMenubar: { nextId: l } };
          })(e, n, L(h), L(p), L(g));
          if ("navigateMenu" in t) h.value = t.navigateMenu.items;
          else if ("navigateMenubar" in t) {
            m.value = !0;
            var o = t.navigateMenubar.nextId;
            (g.value = o), o && E(o);
          }
          p.value = -1;
        },
        handleActivateMenu: E,
        handleDeactivateMenu: k,
        handleDrag: function (e) {
          y.value = { x: e.clientX, y: e.clientY };
        },
        ...
        handleDragMove: function () {
          t.value && ((o.value = !0), (a.value = !1));
        },
        handleDragStart: function (e) {
          (t.value = !0), (o.value = !1), I(e);
        },
        handleMouseEnter: b,
        handleMouseLeave: w,
        handleOnShowMenu: function (e, n) {
          (a.value = e), e ? (g.value = n) : ((g.value = ""), (m.value = !1));
        },
        handleSelected: function (n) {
          M(), e.onSelected(n);
        },
        highlightFirstElement: m,
        isMobileDevice: f,
        menuActive: a,
        menuBarActive: l,
        menuBarRef: n,
  ...
  Y = ["draggable", "showIcon"];
(X.render = function (e, i, u, r, l, d) {
  var h = a("menu-bar-item");
  return (
    n(),
    t(
      "div",
      {
        ref: "menuBarRef",
        class: c([e.dockClass, "menu-bar-container", e.expandClass]),
        draggable: e.draggable,
        tabindex: "0",
        style: s(e.menuBarStyle),
        showIcon: e.showIcon,
        onDragover:
          i[1] ||
          (i[1] = function () {
      ...
      [
        o("header", null, [m(e.$slots, "menuTitle")]),
        o(
          "ul",
          {
            class: c([e.dockClass, "menu-bar-items"]),
            draggable: "true",
            onDragstart:
              i[0] ||
              (i[0] = function () {
              ...
              f(e.menuItems, function (o) {
                return (
                  ...
                  t(
                    ...
                    {
                      key: o.id,
                      class: c([e.dockClass, "v-dock-menu-bar-item-wrapper"]),
                    },
                    [
                      g(
                        h,
  ...
  (X.__scopeId = "data-v-4a501398"),
  (X.__file = "src/components/MenuBar.vue");
export { X as DockMenu };
